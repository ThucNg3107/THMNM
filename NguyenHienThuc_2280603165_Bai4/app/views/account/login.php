            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                <div class="card bg-dark text-white" style="border-radius: 1rem;">
                    <div class="card-body px-4 py-3 text-center">
                        <form action="/NguyenHienThuc_2280603165_Bai4/account/checklogin" method="post">
                            <div class="mb-4">
                            ...
                            <div>
                                <p class="mb-0 small">
                                    ...
                                    <a href="/NguyenHienThuc_2280603165_Bai4/account/register" class="text-white-50 fw-bold">Sign Up</a>
                                </p>
                            </div>
                        </form>
                    </div>
