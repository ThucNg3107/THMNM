...
<div class="container">
    ...
    <a href="/NguyenHienThuc_2280603165_Bai4/Product/add" class="btn btn-danger mb-3">
        Thêm sản phẩm mới
    </a>
<?php endif; ?>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100 shadow-sm border-info rounded">
                    ...
                    <?php if ($product->image): ?>
                        <img src="/NguyenHienThuc_2280603165_Bai4/<?php echo $product->image; ?>" 
                             class="card-img-top" 
                             alt="Product Image" 
                    ...
                    <div class="card-body " style="line-height: 1.3;margin-left:32px">
                        ...
                        <h5 class="card-title mb-4">
                            <a href="/NguyenHienThuc_2280603165_Bai4/Product/show/<?php echo $product->id; ?>" 
                    ...
                    <div class="card-footer text-center">
                       <?php if (SessionHelper::isAdmin()): ?>
    <a href="/NguyenHienThuc_2280603165_Bai4/Product/edit/<?php echo $product->id; ?>" 
       class="btn btn-warning btn-sm">Sửa</a>

    <a href="/NguyenHienThuc_2280603165_Bai4/Product/delete/<?php echo $product->id; ?>"
       class="btn btn-info btn-sm"
       onclick="return confirm('Bạn có chắc chắn muốn xóa sản phẩm này?');">Xóa</a>
<?php endif; ?>

                        <a href="/NguyenHienThuc_2280603165_Bai4/Product/addToCart/<?php echo $product->id; ?>" 
