...
class ProductController
{
 ...
 // Kiểm tra quyền Admin
    ...
    public function save() {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if (is_array($result)) {
                ...
                header('Location: /NguyenHienThuc_2280603165_Bai5_API/Product');
            }
        }
    }
   ...
   // Cập nhật sản phẩm (chỉ Admin)
    ...
    {
        if (!$this->islogin()) {
             header('Location: /NguyenHienThuc_2280603165_Bai5_API/Account/login');
            exit;
        }
        ...
        header('Location: /NguyenHienThuc_2280603165_Bai5_API/Product/cart');
        exit;
    }
    ...
    public function processCheckout()
    {
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            try {
                ...
                header('Location: /NguyenHienThuc_2280603165_Bai5_API/Product/orderConfirmation');
            } catch (Exception $e) {
