    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <?php if ($product->image): ?>
                <img src="/NguyenHienThuc_2280603165_Bai5_API/<?php echo $product->image; ?>"
                     alt="Product Image"
        ...
        <div class="col-md-6">
            ...
            <a href="/NguyenHienThuc_2280603165_Bai5_API/Product/index" class="btn btn-secondary mt-3">Quay lại danh sách</a>
        </div>
    </div>
</div>
